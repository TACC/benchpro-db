...
class ResultFilter(filters.FilterSet):
	...
	task_id = 	filters.CharFilter(lookup_expr='icontains',label='JobID')
	app_id = 	filters.CharFilter(lookup_expr='icontains',label='Application')

	class Meta:
		model = Result
		fields = ['username', 'system', 'task_id', 'submit_time', 'app_id']
...
class AppFilter(filters.FilterSet):
	...
	class Meta:
		model = Application
		fields = ['code', 'version', 'system', 'task_id', 'app_id']
